...
- **Bonus, generative AI.** A SHAP-to-sentence explanation layer, built against a rules-engine baseline and behind a verifier. A naive prompt failed all five students, printing numbers and naming gender, and the guarded prompt passed all five. It runs for a grader with no key off a committed response cache.
...
| 7 Report and repo | full write-up, single-file submission bundle, reproducible code | `reports/final_report.md`, `reports/final_report.pdf`, `reports/submission.pdf`, this repo |
